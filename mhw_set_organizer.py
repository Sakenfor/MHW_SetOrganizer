...
class mhwExpSet(PropertyGroup):
    ...
    obj_views=EnumProperty(name='Object Options Display',items=[(a[0],a[0],a[1],a[2],x) for x,a in enumerate(obj_view_sets)])
...
def MHW_Export(self,context,expwhat='Mod3',gamepath=None,nativePCappend=True,allow_custom_path=True,is_batch=False):
    ...
    if expwhat=='Mod3':
        ...
        for o in [a  for a in _set.eobjs if a.obje in valid_obs]:
            ...
            if o.preserve_quad and (not o.apply_hooks and not skvalid):
